...
#     work_date = models.CharField(db_column='work_Date', max_length=4)  # Field name made lowercase.
#     dayoff = models.ForeignKey(MDayoff, models.DO_NOTHING, db_column='dayoff_Id', blank=True, null=True)  # Field name made lowercase.
